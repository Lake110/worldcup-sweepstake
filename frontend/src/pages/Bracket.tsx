...
export default function BracketPage() {
  ...
  useEffect(() => {
    api.get('/groups/').finally(() => setLoading(false))
  }, [])
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-gray-400 text-sm animate-pulse">Loading bracket...</div>
      </div>
    )
  }
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl sm:text-3xl font-bold text-white mb-1">🏆 Knockout Bracket</h2>
